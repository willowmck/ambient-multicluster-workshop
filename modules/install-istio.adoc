...
[source,bash]
----
include::../steps/install-istio/01.sh[]
----
...
[source,bash]
----
include::../steps/install-istio/02.sh[]
----
...
[source,bash]
----
include::../steps/install-istio/03.sh[]
----
...
[source,bash]
----
include::../steps/install-istio/04.sh[]
----
...
[source,bash]
----
include::../steps/install-istio/05.sh[]
----
...
[source,bash]
----
include::../steps/install-istio/06.sh[]
----
